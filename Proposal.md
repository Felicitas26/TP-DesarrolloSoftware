...
|Req|Detalle|
|:-|:-|
|CRUD |1. CRUD Cliente<br>2. CRUD TipoSalón<br>3. CRUD Ubicación<br>4. CRUD Salon<br>5. CRUD Precio<br>6. CRUD Reserva<br>7. Contrato<br>8. DetalleTarjeta<br>9. ServicioExtra|
